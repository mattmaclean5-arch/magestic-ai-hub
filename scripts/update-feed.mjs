...
const FEEDS = [
  ...
  { url: "https://www.platformer.news/rss", a: "Casey Newton", av: "auto", t: "voice", tags: ["Everyone"], topic: "Industry AI" },
  { url: "https://www.thealgorithmicbridge.com/feed", a: "Alberto Romero", av: "auto", t: "voice", tags: ["Everyone"], topic: "Adoption" },
  { url: "https://stratechery.com/feed", a: "Ben Thompson", av: "auto", t: "voice", tags: ["C-Suite", "Marketing & Sales"], topic: "Industry AI" },
  ...
  { url: "https://www.chinatalk.media/feed", a: "Jordan Schneider", av: "auto", t: "voice", tags: ["C-Suite", "Product Managers"], topic: "Industry AI" },
  { url: "https://www.semianalysis.com/feed", a: "Dylan Patel", av: "auto", t: "voice", tags: ["C-Suite", "Product Managers"], topic: "Industry AI" },
  { url: "https://www.lennysnewsletter.com/feed", a: "Lenny Rachitsky", av: "auto", t: "voice", tags: ["Product Managers"], topic: "Adoption" },
  { url: "https://benn.substack.com/feed", a: "Benn Stancil", av: "auto", t: "voice", tags: ["Database Engineers"], topic: "Tools" },
  ...
  { url: "https://www.astralcodexten.com/feed", a: "Scott Alexander", av: "auto", t: "voice", tags: ["Everyone"], topic: "Adoption" },
  ...
  { url: "https://www.technologyreview.com/feed/", a: "MIT Technology Review", av: "auto", t: "industry", tags: ["Everyone"], topic: "Industry AI" },
  ...
  { url: "https://feeds.arstechnica.com/arstechnica/technology-lab", a: "Ars Technica", av: "auto", t: "industry", tags: ["Developers"], topic: "Industry AI" },
  ...
  { url: "https://www.oreilly.com/radar/feed/index.xml", a: "O'Reilly Radar", av: "auto", t: "industry", tags: ["Developers"], topic: "Adoption" },
  { url: "https://flowingdata.com/feed", a: "FlowingData", av: "auto", t: "voice", tags: ["Database Engineers"], topic: "Tools" },
  { url: "https://sloanreview.mit.edu/feed/", a: "MIT Sloan Mgmt Review", av: "auto", t: "industry", tags: ["C-Suite", "Product Managers"], topic: "Adoption" },
  { url: "https://knowledge.wharton.upenn.edu/feed/", a: "Knowledge at Wharton", av: "auto", t: "industry", tags: ["C-Suite", "Product Managers"], topic: "Adoption" },
  { url: "https://www.mckinsey.com/insights/rss", a: "McKinsey Insights", av: "auto", t: "industry", tags: ["C-Suite", "Product Managers"], topic: "Adoption" },
  ...
  { url: "https://lexfridman.com/feed/podcast/", a: "Lex Fridman Podcast", av: "auto", t: "voice", tags: ["Everyone"], topic: "Adoption" },
  ...
  { url: "https://stackoverflow.blog/feed/", kw: true, a: "Stack Overflow Blog", av: "auto", t: "industry", tags: ["Developers"], topic: "Tools" },
  ...
  { url: "https://thenewstack.io/feed/", kw: true, a: "The New Stack", av: "auto", t: "industry", tags: ["Developers"], topic: "Tools" },
  { url: "https://semiengineering.com/feed/", kw: true, who: "Semiconductor & industrial electronics", a: "Semiconductor Engineering", av: "auto", t: "industry", tags: ["C-Suite", "Application Specialists", "Marketing & Sales"], topic: "Industry AI" },
  { url: "https://singularityhub.com/feed/", a: "Singularity Hub", av: "auto", t: "industry", tags: ["Everyone"], topic: "Adoption" },
  { url: "https://www.quantamagazine.org/feed/", kw: true, a: "Quanta Magazine", av: "auto", t: "industry", tags: ["Everyone"], topic: "Models" },
  ...
  { url: "https://www.eetimes.com/feed/", kw: true, who: "Electronics industry news", a: "EE Times", av: "auto", t: "industry", tags: ["C-Suite", "Application Specialists", "Marketing & Sales"], topic: "Industry AI" },
...
for (const f of FEEDS) {
  try {
    ...
    if (f.kw) feedItems = feedItems.filter(i => AI_KW.test(i.title + " " + i.desc));
